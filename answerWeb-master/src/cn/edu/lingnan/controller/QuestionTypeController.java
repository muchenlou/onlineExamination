...
//				BOSUtil.deleteFile("/resource/images/type/"+oldImageUrl);
	...
	public String addQuestionTypeImages(HttpServletRequest request, @RequestParam(value = "file", required = false) MultipartFile file
        ...
        String typeImagesPath = "/resource/images/"+fileName;
        //上传到临时文件夹
        String typeImagesTempPath = "/temp/"+fileName;
//		BOSUtil.upload(file, typeImagesTempPath);
		String httpPath= request.getSession().getServletContext().getRealPath("/");
...
//		}
		...
		file.transferTo(new File(httpPath+typeImagesPath));//保存文件
